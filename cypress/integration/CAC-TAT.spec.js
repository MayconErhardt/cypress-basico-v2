...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('preenche e lipa os nome, sobrenome, e-mail e telefone', function(){
        cy.get('#firstName').type('Maycon').should('have.value', 'Maycon').clear().should('have.value', '')
        cy.get('#lastName').type('Erhardt').should('have.value', 'Erhardt').clear().should('have.value', '')
        cy.get('#email').type('mayconerhardtyquast@gmail.com').clear().should('have.value', '')
        cy.get('#phone').type('1234567890').clear().should('have.value', '')    
    })
